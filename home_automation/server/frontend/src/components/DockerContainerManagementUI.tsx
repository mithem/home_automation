...
export default class DockerContainerManagementUI extends React.Component<
  {},
  { containers: DockerContainerData[]; error?: Error; loading: boolean }
> {
  timerID: any;
